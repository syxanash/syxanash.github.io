  ...
  constructor(props) {
    ...
    this.state = {
      ...
      bootMessages: [
        ...
        computerFixed ? null : <div>&nbsp;&nbsp;<span className='console-text-green'>Found kernel anomaly at: <span className='console-text-yellow'>root/.workspace/.cestino.</span></span></div>,
