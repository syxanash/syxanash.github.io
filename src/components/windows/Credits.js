    ...
    return (<div className='credits-window'>
      <div>
        ...
        <p>
          ...
          You are more than welcome to add this site to your linkroll or links page, here's a <a href='https://system32.simone.computer/assets/88x31.gif' target='_blank' rel='noopener noreferrer'>88x31 button</a> if you're fond of the aul web.
        </p>
      </div>
