  ...
  render = () => {
    ...
    return (<div className='credits-window'>
      ...
      <Tabs value={ activeTab } onChange={ this.handleChangeTab } style={ { paddingTop: '10px' } }>
        ...
        <Tab style={ { cursor: `url(${blackCursor}), auto` } } value={ 1 }>Images</Tab>
        <Tab style={ { cursor: `url(${blackCursor}), auto` } } value={ 2 }>Sounds</Tab>
        <Tab style={ { cursor: `url(${blackCursor}), auto` } } value={ 3 }>Links</Tab>
        <Tab style={ { cursor: `url(${blackCursor}), auto` } } value={ 4 }><img height='15px' src={ cookieIcon } alt='cookie' />&nbsp;Cookies</Tab>
      </Tabs>
      <TabBody>
        <div style={ { marginTop: '-5px' } }>
          <Cutout style={ { backgroundColor: '#e9e8ff' } } shadow={ false }>
            ...
            <ul style={ { display: activeTab === 1 ? 'block' : 'none' } }>
              ...
              <li className='list-content'><a href='http://cs.gettysburg.edu/~duncjo01/assets/images/patterns/' target='_blank' rel='noopener noreferrer'>Tile Backgrounds</a> → Some patterns were downloaded from the amazing collection made by John D. Duncan, III</li>
              <li className='list-content'><a href='https://pixelmoondust.neocities.org/archives/archivedtiles' target='_blank' rel='noopener noreferrer'>Tile Backgrounds</a> → Some tile backgrounds were downloaded from this neocities collection</li>
              ...
              <li className='list-content'><b>pin.png</b> in Blog is a free PNG found online and has been slightly modified.</li>
