      ...
      <React.Fragment>
        <div className='toolbar-container'>
          <Toolbar>
            ...
            { Util.isMobile() ? null : <Button onClick={ () => Util.openWebsiteURL({ url: 'https://ko-fi.com/syxanash' }) } variant="menu"><img src={ pizzaSlice } alt='hyperlink' style={ { paddingRight: '7px' } } />Support</Button> }
